...
for i in lang_codes:
    url = "https://wdq.wmflabs.org/api?q=link[" + i + "wiki]%20and%20noclaim[31:4167836]%20and%20noclaim[31:15647814]%20and%20noclaim[31:11266439]&noitems=1"
...
for i in lang_codes:
    for j in lang_codes:
        if i < j:
            url = "https://wdq.wmflabs.org/api?q=link[" + i  + "wiki]%20and%20link[" + j + "wiki]%20and%20noclaim[31:4167836]%20and%20noclaim[31:15647814]%20and%20noclaim[31:11266439]&noitems=1"
            nb = nb_items(url)
